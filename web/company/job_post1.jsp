...
<%--    <li ><a href='index.jsp'><span>About us</span></a></li>
 --%></li>
   ...
   <li ><s:a action="log_out"><span>Logout</span></s:a></li>
      ...
      <div class="main">
	     <form method="post" action="update_job" name="myform" onSubmit="return validationForm()" class="register" style="margin-left:0px;">
            <h1>Post Job Here</h1>
            <fieldset class="row1">
                <legend>Job Details
                </legend>
                    ...
                    <input type="text" placeholder="job profile" name="profile" value="<s:property value="#session.edit_job.profile"/>" autoFocus required />
                    <label>Job Id*
                    </label>
                    <input type="text" placeholder="job id" name="jobid" value="<s:property value="jobid"/>" required />   
                </p>
                <p>
                <label>Job Industry*
                </label>
                ...
                <p>
                    ...
                    <sd:datetimepicker name="jobpostdate" value="#session.edit_job.jobpostdate" displayFormat="dd-MMM-yyyy"/>
                </p>
                <p>
                	<label>Salary*
                    </label>
                    ...
                    <input type="text"  placeholder="job description" name="description" value="<s:property value="#session.edit_job.description"/>"  required ></textarea>
 			...
 			<div><button type="submit" class="button">Update &raquo;</button></div>
        </form>
		<div class="main1">
