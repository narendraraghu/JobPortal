   ...
   <li class='has-sub last'><a href='#'><span>Admissions</span></a>
      ...
      <table>
		...
		<th><h3><s:property value="#session.valid_Student"/></h3></th>
	     ...
	     <s:form method="post" action="post_the_job" name="myform" onSubmit="return validationForm()" class="register" style="margin-left:0px;">
            <h1>Post Job Here</h1>
			...
			<div><button type="submit" class="button">Post Job &raquo;</button></div>        </s:form>
		<div class="main1">
